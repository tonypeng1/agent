...
async def main():
    ...
    6. Add a gate to stop if the date content's format is not valid.
    7. The fifth agent modifies the table content to add the current date as the first column.
    ...
    10. The seventh agent analyzes the trends in ETF activity based on the filtered tables.
    """
    ...
    analyze_etf_trends_agent = Agent(
        ...
        instructions=(
            ...
            "Identify and analyze trends in ETF activity, focusing on changes in volume, rankings, and any other notable differences. "
            "Quantify changes in both volume and AUM as percentages where possible. "
            "Summarize your analysis in a list of findings. Explicitly mentioning the dates of both tables and stating that share volume "
        ...
        with trace("Deterministic story flow"):
            ...
            while retry_count < max_retries:
                try:
                    ...
                    await asyncio.sleep(1)  # Optional: short delay before retry
